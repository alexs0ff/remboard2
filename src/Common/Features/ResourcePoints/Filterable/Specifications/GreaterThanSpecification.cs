...
namespace Common.Features.ResourcePoints.Filterable.Specifications
{
    public class GreaterThanSpecification<T> : ISpecification<T>
        where T : class
    {
        ...
        public Expression<Func<T, bool>> IsSatisfiedBy()
        {
            ...
            var equal = Expression.GreaterThan(prop, valueConstant);
