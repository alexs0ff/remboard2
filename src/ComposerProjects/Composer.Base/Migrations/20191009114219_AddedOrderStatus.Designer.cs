...
namespace Composer.Base.Migrations
{
    ...
    [Migration("20191009114219_AddedOrderStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orders.OrderStatus.OrderStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Orders.OrderStatus.OrderStatusKind", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Orders.OrderStatus.OrderStatus", b =>
                {
                    b.HasOne("Orders.OrderStatus.OrderStatusKind", "OrderStatusKind")
                        .WithMany()
